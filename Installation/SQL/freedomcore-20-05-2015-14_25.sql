...
--
-- Хост: localhost
-- Время создания: Май 20 2015 г., 06:25
...
INSERT INTO `news` (`id`, `title`, `short_description`, `full_description`, `posted_by`, `post_date`, `post_miniature`) VALUES
(1, 'Новый транспорт: мистический руноклык', 'В Азероте объявилось загадочное ездовое животное: мистический руноклык.', 'В Азероте объявилось загадочное ездовое животное: мистический руноклык. До сих пор его скрывала хаотическая энергия магии, и много тысячелетий его никому не удавалось изловить. Но теперь он выступил из тени в поисках нового источника магической силы. ', 'Blizzard Entertainment', '2015-05-13 00:00:00', '85K3DFU0328G1431426884989.jpg');
...
('-GxZk6CNb39pD3JFEjvSlM1s6OnHqGPDtlEpVOTu-P,qZBk2gvN2a4hFZgEvjHN1vm-kJ,DDXt0ZWQvPdArwD3', '1432103065', 'o1FIWktl24q0/VDhiZDlwaOmD9BrXqXL/DJ9G7bQ3glVDx6nRyHsHH9mUi0LUMkc4mFSHdOjb/uJEkwmeP2gYQ==', 'f3b9ee9c770d01f183d4ad8db45521de4676be5dd4937c58fb1b81b2d9f5bb94107f1fb975db393870116a52e817ebe4f995543342703c3b6abd0c7c8e8b64c4');
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `registration_date`, `access_level`) VALUES
(1, 'darki73', 'b7a053677ea4f961c5bda05e9e73e2750dcc1872', 'apple.zhivolupov@gmail.com', '2015-05-18 00:48:05', 4);
