                    ...
                    <div class="service-wrapper">
                        ...
                        <div class="service-form">
                            <div class="service-interior">
                                ...
                                <span class="clear"></span>
                                <form method="POST" action="/account/management/services/character-services?accountName=WoW{$Account.id}&amp;service={$Service.service}&amp;servicecat=confirm&amp;character={$Character.name}">
                                    <fieldset class="ui-controls section-stacked">
                                        ...
                                        <a class="ui-cancel " href="/account/management/services/character-services?accountName=WoW{$Account.id}&service={$Service.service}" tabindex="1">
                                            <span>
