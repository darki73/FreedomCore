    ...
    <div class="wrapper">
        <div id="content">
            <div  id="page-header">
                ...
                <br />
                <h3 class="headline">{#Administrator_Shop_EditItem#}</h3>
                <h2 class="subcategory">{#Administrator_Shop_Edit_Item_Subheader#}</h2>
            </div>
                            ...
                            <div class="service-tag">
                                <div class="service-tag-contents border-3">
                                    <div class="service-tag-description">
                                        <span class="character-message caption">{#Administrator_Shop_Edit_Item_SideTitle#}</span>
                                    </div>
                        ...
                        <div class="service-form">
                            <div class="character-list">
                                <ul id="character-list">
                                    ...
                                    <a href="/admin/shop/edit-item/?itemid={$Item.id}" class="character-link">
