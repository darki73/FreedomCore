...
var ForumTopic = {
    ...
    quoteTopic: function(b) {
        ...
        if (ForumTopic.cachedQuotes[a]) {
            var c = ForumTopic.cachedQuotes[a];
            BML.quote(c.detail, a);
        } else {
            $.ajax({
                dataType: "json",
                type: "GET",
                url: Core.baseUrl + "/forum/topic/post/" + a + "/frag",
                success: function(d) {
                    ForumTopic.cachedQuotes[a] = d;
                    BML.quote(d.detail, a);
                }
            });
        }
    },
    ...
    requestSticky: function(b, a) {
        ...
        $.ajax({
            type: "POST",
            url: Core.baseUrl + "/forum/topic/post/" + a + "/report",
            data: {
                type: "STICKY_REQUEST",
                reason: " ",
                xstoken: Cookie.read("xstoken")
