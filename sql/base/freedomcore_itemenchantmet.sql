...
--
-- Структура таблицы `freedomcore_itemenchantmet`
--

CREATE TABLE IF NOT EXISTS `freedomcore_itemenchantmet` (
  `itemenchantmetID` smallint(3) unsigned NOT NULL,
  `text_loc0` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;

--
-- Дамп данных таблицы `freedomcore_itemenchantmet`
--

INSERT INTO `freedomcore_itemenchantmet` (`itemenchantmetID`, `text_loc0`) VALUES
(1, 'Rockbiter 3'),
(2, 'Frostbrand 1'),
(3, 'Flametongue 3'),
(4, 'Flametongue 2'),
...
--
-- Индексы таблицы `freedomcore_itemenchantmet`
--
ALTER TABLE `freedomcore_itemenchantmet`
 ADD PRIMARY KEY (`itemenchantmetID`);
