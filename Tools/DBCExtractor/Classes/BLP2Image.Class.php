...
Class BLP2Image
{
	...
	private static function icfb1($width, $height, $palette, $data)
	{
	...
	private static function icfb2($width, $height, $data, $alphaBits, $alphaType)
	{
	...
	private static function icfb3($width, $height, $data)
	{
		$img = imagecreatetruecolor($width, $height);
		$i = unpack("V*", $data);
		for ($y = 0; $y < $height; $y++)
